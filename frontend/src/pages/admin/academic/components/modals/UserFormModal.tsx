...
import {
  ...
  DialogTitle,
  DialogFooter,
} from '@/pages/admin/academic/components/ui/dialog';
import { Button } from '@/pages/admin/academic/components/ui/button';
import { Input } from '@/pages/admin/academic/components/ui/input';
import { Label } from '@/pages/admin/academic/components/ui/label';
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from '@/pages/admin/academic/components/ui/select';
