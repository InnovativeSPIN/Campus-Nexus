...
import { menteeStudents, StudentProfile } from "@/pages/admin/department-admin/data/menteeStudents";
...
import { AcademicsPlaceholder } from "@/pages/admin/department-admin/components/mentor/AcademicsPlaceholder";
